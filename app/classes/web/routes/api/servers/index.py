        ...
        "minecraft_java_create_data": {
            ...
            "properties": {
                "create_type": {
                    ...
                    "enum": ["download_jar", "import_server", "modpack"],
                    "error": "enumErr",
                    "fill": True,
                },
                "modpack_create_data": {
                    "title": "Modpack creation data",
                    "type": "object",
                    "error": "enumErr",
                    "fill": True,
                    "required": [
                    ...
                    "properties": {
                        "source": {
                            "title": "Where the pack comes from",
                            "type": "string",
                            "enum": ["modrinth", "curseforge", "upload"],
                            "error": "enumErr",
                            "fill": True,
                        },
                        "project_id": {
                            "title": "Modrinth project id / CurseForge mod id",
                            "type": "string",
                            "error": "typeString",
                            "fill": True,
                        },
                        "version_id": {
                            "title": "Modrinth version id / CurseForge file id",
                            "type": "string",
                            "error": "typeString",
                            "fill": True,
                        },
                        "archive_name": {
                            "title": "Uploaded .mrpack / .zip in import/upload",
                            "type": "string",
                            "error": "typeString",
                            "fill": True,
                        },
                        "pack_token": {
                            "title": "Token from /api/v2/crafty/modpack resolve",
                            "type": "string",
                            "error": "typeString",
                            "fill": True,
                        },
            ...
            "allOf": [
                {
                    ...
                    "allOf": [
                        ...
                        {
                            "if": {"properties": {"create_type": {"const": "modpack"}}},
                            "then": {"required": ["modpack_create_data"]},
                        },
                    ],
                },
                {
